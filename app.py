...
# --- Подсказки пользователю + запуск обработки ---
if file_journal is None:
    ...
    if st.button("🚀 Обработать данные"):
        try:
            ...
            # ⬅ дальше уже должен идти твой код Шага 3 (предпросмотр и выгрузка)
...
# Добавляем «Причина отсутствия» только если она реально заполнена
if show_reason:
