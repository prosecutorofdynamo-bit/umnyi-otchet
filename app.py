        ...
        try:
            ...
            if not allowed:
                st.error(
                    ...
                    "Если вам нужен дополнительный доступ — напишите нам, и мы оперативно подключим "
                    "или сможем выдать дополнительные тестовые запуски."
                )
            else:
                try:
                    ...
                    if free_left > 0:
                        st.info(f"Осталось бесплатных скачиваний: {free_left}.")
                    else:
                        st.info("Бесплатных скачиваний больше не осталось.")
